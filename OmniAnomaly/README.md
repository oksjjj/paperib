...
데이터·다운로드/preprocess 스크립트는 repo 루트 ``../data/``, ``../scripts/`` 를 사용합니다.
...
../.venv/bin/python ../scripts/eval_from_scores.py --dataset SMAP
...
../.venv/bin/python ../scripts/viz_gt_anomalies.py --dataset machine-1-1 --run_name noprior_noes_paper
```
